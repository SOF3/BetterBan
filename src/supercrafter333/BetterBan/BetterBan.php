...
use DateInterval;
use DateTime;
use supercrafter333\BetterBan\libs\_9bca723c5bc8818b\dktapps\pmforms\BaseForm;
use Exception;
...
class BetterBan extends PluginBase {
	...
	public static function pmformsExists() : bool {
		return class_exists(\supercrafter333\BetterBan\libs\_9bca723c5bc8818b\dktapps\pmforms\BaseForm::class);
	}
